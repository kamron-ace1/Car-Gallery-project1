...
function openCarModal(car) {
  ...
  switch (car.series) {
    case "sedan":
      seriesText = "SEDAN SERIES";
      break;
    case "coupe":
      seriesText = "COUPE SERIES";
      break;
    case "suv":
      seriesText = "SAV SERIES";
      break;
    case "m":
      seriesText = "M PERFORMANCE";
      break;
    case "electric":
      seriesText = "ELECTRIC i SERIES";
      break;
    default:
      seriesText = car.series.toUpperCase();
  }
...
function shareCar() {
  if (currentCar && navigator.share) {
    ...
    showToast(
      translations[currentLanguage]?.["link-copied"] ||
